...
# Install the server
RUN wget --no-check-certificate -O /gremlin.zip http://apache.mirrors.ovh.net/ftp.apache.org/dist/tinkerpop/3.3.0/apache-tinkerpop-gremlin-server-3.3.1-bin.zip && \
